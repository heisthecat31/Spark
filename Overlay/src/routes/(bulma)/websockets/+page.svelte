...
<Header
	title="Spark Websocket API"
	subtitle="Subscribe to events in the browser. This makes event-driven overlays very simple."
/>
...
<div class="content" style="max-width: 60em; margin: auto;">
	...
	<div class="box">
		...
		<pre><code class="language-js"
				>{`<script src="http://localhost:6724/js/spark_websocket.js"></script>
